...
export const Watch = () => {
  const { id } = useParams(); //here whatever we get from params we get in the string format
  ...
  const video = videos.find((v) => String(v.video_id) === id);

  console.log(video);

  if (!video || status === "loading") {
    return <div className="p-40">Loading video or video not found...</div>;
  }
  return (
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="flex-1 w-full">
          <div className="relative pb-[56.25%] h-0 mb-4">
            <div clclassName="absolute inset-0">
              <iframe
                src={`https://www.youtube.com/embed/${video.video_id}?autoplay=1&mute=1&controls=0&loop=1&playlist=${video.video_id}`}
          ...
          <div
            class="group mb-4 w-full rounded-lg border p-4 duration-200 bg-blue-200 hover:bg-blue-300 focus:bg-blue-400"
            role="button"
            tabindex="0"
          >
            <div class="flex flex-wrap gap-y-2">
              <div class="w-full md:w-1/2 lg:w-full xl:w-1/2">
                <h1 class="text-lg font-bold text-blue-950">{video.title}</h1>
                <p class="flex text-sm text-gray-600">{video.views} Views</p>
              </div>
              <div class="w-full md:w-1/2 lg:w-full xl:w-1/2">
                <div class="flex items-center justify-between gap-x-4 md:justify-end lg:justify-between xl:justify-end">
                  ...
                  <div class="relative block">
                    <button class="peer flex items-center gap-x-2 rounded-lg bg-white px-4 py-1.5 text-black font-mono">
                    ...
                    <div class="absolute right-0 top-full z-10 hidden w-64 overflow-hidden rounded-lg bg-blue-300 p-4 shadow shadow-slate-50/30 hover:block peer-focus:block">
            ...
            <div class="mt-4 flex items-center justify-between">
              <div class="flex items-center gap-x-4">
                ...
                <div class="block">
                  <p class="text-red-600">{video.channeltitle}</p>
                  <p class="text-sm text-amber-950">757K Subscribers</p>
                </div>
              </div>
              <div class="block">
            ...
            <div>
              <div class="flex gap-x-4">
                ...
                <div class="block">
                  ...
                  <p class="mt-3 text-sm">
                    Higher-order components have been a mystery to me for far
                    too long. Looking forward to demystifying them with this
                    series. Thanks!
                  </p>
                </div>
              </div>
              ...
              <div class="flex gap-x-4">
                ...
                <div class="block">
                  ...
                  <p class="mt-3 text-sm">
                    ...
                    components are something I&#x27;ve been eager to master.
                    Thanks for this!
                  </p>
                </div>
              </div>
            ...
            <div>
              <div class="flex gap-x-4">
                ...
                <div class="block">
                  ...
                  <p class="mt-3 text-sm">
                    This series looks amazing! I&#x27;m especially excited to
                    learn more about controlled vs. uncontrolled components.
                    Thanks for sharing!
                  </p>
                </div>
              </div>
          ...
          <div class="w-full gap-x-2 border pr-2 md:flex">
            <div class="relative mb-2 w-full md:mb-0 md:w-5/12">
              <div class="w-full pt-[56%]">
                ...
                <span class="absolute bottom-1 right-1 inline-block rounded  px-1.5 text-sm">
                  20:45
                </span>
              </div>
            </div>
            <div class="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
              ...
              <div class="w-full pt-1 md:pt-0">
                ...
                <p class="mb-0.5 mt-2 text-sm text-gray-200">Code Master</p>
          ...
          <div class="w-full gap-x-2 border pr-2 md:flex">
            ...
            <div class="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
              ...
              <div class="w-full pt-1 md:pt-0">
                ...
                <p class="mb-0.5 mt-2 text-sm text-gray-200">Express Learner</p>
                <p class="flex text-sm text-gray-200">
          ...
          <div class="w-full gap-x-2 border pr-2 md:flex">
            ...
            <div class="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
              ...
              <div class="w-full pt-1 md:pt-0">
                ...
                <p class="mb-0.5 mt-2 text-sm text-gray-200">API Builder</p>
                <p class="flex text-sm text-gray-200">
          ...
          <div class="w-full gap-x-2 border pr-2 md:flex">
            ...
            <div class="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
              ...
              <div class="w-full pt-1 md:pt-0">
                ...
                <p class="mb-0.5 mt-2 text-sm text-gray-200">Hook Master</p>
                <p class="flex text-sm text-gray-200">
          ...
          <div class="w-full gap-x-2 border pr-2 md:flex">
            ...
            <div class="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
              ...
              <div class="w-full pt-1 md:pt-0">
                ...
                <p class="mb-0.5 mt-2 text-sm text-gray-200">Django Master</p>
                <p class="flex text-sm text-gray-200">
          ...
          <div class="w-full gap-x-2 border pr-2 md:flex">
            ...
            <div class="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
              ...
              <div class="w-full pt-1 md:pt-0">
                ...
                <p class="mb-0.5 mt-2 text-sm text-gray-200">Passport Pro</p>
                <p class="flex text-sm text-gray-200">
          ...
          <div class="w-full gap-x-2 border pr-2 md:flex">
            ...
            <div class="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
              ...
              <div class="w-full pt-1 md:pt-0">
                ...
                <p class="mb-0.5 mt-2 text-sm text-gray-200">Tableau Master</p>
                <p class="flex text-sm text-gray-200">
          ...
          <div class="w-full gap-x-2 border pr-2 md:flex">
            ...
            <div class="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
              ...
              <div class="w-full pt-1 md:pt-0">
                ...
                <p class="mb-0.5 mt-2 text-sm text-gray-200">CSS Animations</p>
                <p class="flex text-sm text-gray-200">
          ...
          <div class="w-full gap-x-2 border pr-2 md:flex">
            ...
            <div class="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
              ...
              <div class="w-full pt-1 md:pt-0">
                ...
                <p class="mb-0.5 mt-2 text-sm text-gray-200">React Patterns</p>
                <p class="flex text-sm text-gray-200">
